...
bpy.context.scene.objects.link(graph)
bpy.context.scene.objects.active = graph
graph.select = True
...
bpy.ops.mesh.primitive_uv_sphere_add(location=(0,0,0), size = .3, ring_count = 48, segments = 48)
sphere=bpy.context.object
bpy.context.active_object.name = 'Carbon Atom A'
sphere.data.materials.append(mat)
bpy.data.objects['Carbon Atom A'].parent = bpy.data.objects['graph']
bpy.ops.mesh.primitive_uv_sphere_add(location=(0,-a,0), size = .3, ring_count = 48, segments = 48)
sphere=bpy.context.object
bpy.context.active_object.name = 'Carbon Atom B'
sphere.data.materials.append(mat)
bpy.data.objects['Carbon Atom B'].parent = bpy.data.objects['graph']
bpy.ops.mesh.primitive_uv_sphere_add(location=(np.sqrt(3)*a/2,-3*a/2,0), size = .3, ring_count = 48, segments = 48)
sphere=bpy.context.object
bpy.context.active_object.name = 'Carbon Atom C'
sphere.data.materials.append(mat)
bpy.data.objects['Carbon Atom C'].parent = bpy.data.objects['graph']
bpy.ops.mesh.primitive_uv_sphere_add(location=(np.sqrt(3)*a,-a,0), size = .3, ring_count = 48, segments = 48)
sphere=bpy.context.object
bpy.context.active_object.name = 'Carbon Atom D'
sphere.data.materials.append(mat)
bpy.data.objects['Carbon Atom D'].parent = bpy.data.objects['graph']
bpy.ops.mesh.primitive_uv_sphere_add(location=(np.sqrt(3)*a,0,0), size = .3, ring_count = 48, segments = 48)
sphere=bpy.context.object
bpy.context.active_object.name = 'Carbon Atom E'
sphere.data.materials.append(mat)
bpy.data.objects['Carbon Atom E'].parent = bpy.data.objects['graph']
bpy.ops.mesh.primitive_uv_sphere_add(location=(np.sqrt(3)*a/2,a/2,0), size = .3, ring_count = 48, segments = 48)
sphere=bpy.context.object
...
bpy.data.objects['graph'].dupli_type = 'VERTS'

#######################

mesh_lower = bpy.data.meshes.new('mesh_lower')
graph_lower = bpy.data.objects.new('graph_lower', mesh_lower)
bpy.context.scene.objects.link(graph_lower)
bpy.context.scene.objects.active = graph_lower
graph_lower.select = True
...
bpy.ops.mesh.primitive_uv_sphere_add(location=R.dot((0,-a,0)), size = .3, ring_count = 48, segments = 48)
sphere=bpy.context.object
...
bpy.ops.mesh.primitive_uv_sphere_add(location=R.dot((np.sqrt(3)*a/2,-3*a/2,0)), size = .3, ring_count = 48, segments = 48)
sphere=bpy.context.object
...
bpy.ops.mesh.primitive_uv_sphere_add(location=R.dot((np.sqrt(3)*a,-a,0)), size = .3, ring_count = 48, segments = 48)
sphere=bpy.context.object
...
bpy.ops.mesh.primitive_uv_sphere_add(location=R.dot((np.sqrt(3)*a,0,0)), size = .3, ring_count = 48, segments = 48)
sphere=bpy.context.object
...
bpy.ops.mesh.primitive_uv_sphere_add(location=R.dot((np.sqrt(3)*a/2,a/2,0)), size = .3, ring_count = 48, segments = 48)
sphere=bpy.context.object
...
au_mat.diffuse_color=(1,.75,.25)
bpy.ops.mesh.primitive_cube_add()
gold=bpy.context.object
bpy.context.active_object.name = 'Au'
bpy.context.scene.objects.active.scale = (8*a, 8*a, 0.5*a)
...
sio2_mat.diffuse_color=(0.42,.24,0.67)
bpy.ops.mesh.primitive_cube_add()
sio2=bpy.context.object
bpy.context.active_object.name = 'SiO2'
bpy.context.scene.objects.active.scale = (30*a,30*a, 2*a)
...
si_mat.diffuse_color=(0.5,0.5,0.5)
bpy.ops.mesh.primitive_cube_add()
si=bpy.context.object
bpy.context.active_object.name = 'Si'
bpy.context.scene.objects.active.scale = (30*a,30*a, 4*a)
...
bpy.context.scene.objects.active.scale = (5*a,5*a, -10*a)
